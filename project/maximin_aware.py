...
def divide_and_choose_for_three(alloc: AllocationBuilder, explanation_logger: ExplanationLogger = ExplanationLogger()):
    """
    Algorithm 1: Finds a mma1 allocation for 3 agents using leximin-n-partition.
    ...
    def repartition(agent1, agent2, items):
        ...
        priorities_other = get_bundle_rankings(alloc.instance.agent_bundle_value, agent1, partition2)
    ...
    priorities1 = get_bundle_rankings(alloc.instance.agent_bundle_value, agents[0], partition1)
    priorities2 = get_bundle_rankings(alloc.instance.agent_bundle_value, agents[1], partition1)
